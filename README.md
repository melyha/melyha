...
## Key Strengths 🎯
- **UX/UI Design** with development implementation
- **Mobile-first** approach (React Native + Expo)
- **Full-stack mindset** (frontend focus with backend awareness)
- **Creative + Technical** problem solving
- **Multilingual**: English, Urdu, Hindi, Punjabi

## Current Projects 🔭
- **Digital Brand Studio** - Full-service branding, UX/UI, and web development
- **React Native Apps** - Mobile development coursework
- **WordPress Development** - Custom themes with animations
